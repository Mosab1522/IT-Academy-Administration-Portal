...
<x-setting heading="{{$coursetype->name}}">
    ...
    <div class="flex flex-wrap px-6 pb-10 border-b border-gray-200">
        <x-show-header name="{{$coursetype->name}}" title="Kurz"/>
            <x-buttonsection>
...
{{-- 
                    ...
                    <div id="profile" class="section flex-auto p-6"
                        ...
                        <form id="formm" action="/admin/coursetypes/{{$coursetype->id}}" method="post"
                            ...
                            <x-form.field>
                                <x-form.input
                                    value="{{$coursetype->name}}" name="cname" type="text" title="Názov" placeholder="Názov" disabled />
                            </x-form.field>
    ...
    for="type_student" 
    value="0" 
    :checked="$coursetype->type == 0"
    :disabled="true">
                                    Študentský
                                    
                                </x-form.input-radio>
                                <x-form.input-radio class="ml-6" name="type" for="type_instructor" value="1" :checked="$coursetype->type == 1"
                                    :disabled="true" >
                                    Inštruktorský
                                </x-form.input-radio>
                            </div>
            ...
            <x-form.field>
                <x-form.input name="min" type="number" title="Minimum študentov" placeholder="Minimum" disabled/>
                </x-form.field>
                <x-form.field>
                <x-form.input name="max" type="number" title="Maximum študentov" placeholder="Maximum" disabled/>
                </x-form.field>
                                {{--
                        ...
                        <form action="/admin/coursetype_instructor" method="POST">
                            @csrf
                                ...
                                <x-form.field>
                                    ...
                                    <option class="text-gray-500" value="" disabled selected hidden>Inštruktori</option>
                                    {{-- @php
