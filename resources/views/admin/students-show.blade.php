                                ...
                                <div class="relative right-0">
                                    <ul class="relative flex flex-wrap p-1 list-none bg-gray-50 rounded-xl" nav-pills
                                        ...
                                        <li class="flex-1 {{ session('success_d') ? 'hidden' : '' }}">
                                            <button
                                                class="edit-button {{ session('success_c') || session('success_d') || request()->has('pridat') ? 'hidden' : '' }} "
                                                data-target="profile">
                                        ...
                                        <li
                                            class="flex-1 {{ session('success_c') || session('success_d') || request()->has('pridat') ? '' : 'hidden' }}">
                                            <button
                                                class="add-button  {{ session('success_c') || session('success_d') || request()->has('pridat') ? '' : 'hidden' }}  "
                            ...
                            <div
                                ...
                                <div class="relative right-0">
                                    <ul class="relative flex flex-wrap p-1 list-none bg-gray-50 rounded-xl" nav-pills
                                        ...
                                        <li class="flex-auto pr-0.5">
                                            <button
                                                class="section-button {{ session('success_c') || session('success_d') || request()->has('pridat') ? '' : 'hidden' }} rounded-lg"
                                ...
                                <div id="profile" class="section flex-auto p-6"
                                    ...
                                    <div class="flex flex-col  md:grid md:grid-cols-2 lg:flex lg:flex-row  gap-6">
                                        <div class=" mt-6">
                                            ...
                                            <div class="flex items-center mt-1">
                                                ...
                                                <x-form.input-radio class="ml-4" name="status" for="type_nostudent"
                                                    value="nestudent"  :checked="$student->status == 'nestudent'" disabled>
                                                    Neštudent
                                                </x-form.input-radio>
                                            ...
                                            <div class="flex flex-col mt-0 md:mt-6 {{ $student->skola ? '' : 'hidden' }}" id="ucm">
                                                ...
                                                <div class="flex mt-1">
                                                    <div class="flex items-center mr-4">
                                                        <x-form.input-radio name="skola" for="ucmka" value="ucm" :checked="$student->skola == 'ucm'" disabled>
                                                            UCM
                                                        </x-form.input-radio>
                                                    ...
                                                    <div class="flex items-center">
                                                        <x-form.input-radio name="skola" for="inam" value="ina" :checked="$student->skola !== 'ucm' && $student->skola !== null" disabled>
                                                            Iná
                                                        </x-form.input-radio>

                                                        {{-- <input type="radio" id="inam" name="skola" value="ina"
                                                            class="w-6 h-6 lg:w-4 lg:h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500" {{ $student->skola == 'ucm' || $student->skola == null ? ''
                                                :
                                                ' checked' }} disabled>
                                            ...
                                            <div class="flex flex-col mt-0 lg:mt-6 {{ $student->skola == 'ucm' ? '' : 'hidden' }}" id="ucmkari" >
                                                <x-form.label name="studium" title="Druh štúdia" />
                                                <div class="flex mt-1">
                                                    <div class="flex items-center mr-4">
                                                        <x-form.input-radio name="studium" for="option3" value="interne" :checked=" $student->studium == 'interne'" disabled>
                                                            Interné
                                                        </x-form.input-radio>
                                                        
                                                        {{-- <input type="radio" id="option3" name="studium" value="interne"
                                                            class="w-6 h-6 lg:w-4 lg:h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500" {{
                                                                $student->studium == 'interne' ? 'checked' : '' }} disabled>
                                            ...
                                            <!-- Program selection -->
                                            <div class="flex flex-col mt-0 lg:mt-6 {{ $student->skola == 'ucm' ? '' : 'hidden' }}" id="ucmkari2" >
                                                ...
                                                <div class="flex lg:mt-1">
                                                    ...
                                                    <div class="flex items-center lg:items-baseline">
                                                        <input type="radio" id="option6" name="program" value="iny"
                                                            class="w-6 h-6 lg:w-4 lg:h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500 disabled:text-gray-500" {{ $student->program == 'apin' || $student->program == null ? ''
                                                            :
                                                            ' checked' }} disabled>
                                        ...
                                        <div id="ina" class="mt-4 {{ $student->skola == 'ucm' || $student->skola == null ? 'hidden' : '' }}" >
                                            <input type="text" disabled
                                                ...
                                                name="ina" id="nu" placeholder="Názov školy"  value="{{ $student->skola == 'ucm' ? '' : $student->skola }}">
                                        </div>
                                        <div id="iny" class="mt-4 {{ $student->program == 'apin' || $student->program == null ? 'hidden' : '' }}" >
                                                    <input type="text" disabled
                                                        ...
                                                        name="iny" id="ny" placeholder="Názov programu"  value="{{ $student->program == 'apin' ? '' : $student->program }}">
                                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex pb-1">
                                        ...
                                        <x-form.field>
                                            <x-form.input value="{{$student->ulicacislo}}" name="ulicacislo" type="text" title="Ulica a popisné číslo"
                                                placeholder="Ulica a popisné číslo" disabled />
                                        </x-form.field>
                                        <x-form.field>
                                            <x-form.input  value="{{$student->mestoobec}}"  name="mestoobec" type="text" title="Mesto / Obec"
                                                placeholder="Mesto / Obec" disabled />
                                        </x-form.field>
                                        <x-form.field>

                                            <x-form.input  value="{{$student->psc}}"  name="psc" type="text" title="PSČ" placeholder="PSČ" disabled />
                                        </x-form.field>
                                        {{-- <x-form.field>
                                            <button type="submit"
                                            ...
                                            <x-form.field>
                                                ...
                                                <div class="items-center mt-6">
                                                    ...
                                                    <div class="flex items-center mt-1">
                                                        ...
                                                        <x-form.input-radio class="ml-6" name="type"
                                                            for="type_instructor" value="1">
                                                            Inštruktorský
                                                        </x-form.input-radio>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-6 hidden" id="inst">
                                                    ...
                                                    <div class="w-1/2 mr-2">
                                                        <x-form.select name="academy_id" title="Akadémia"
                                                            class=" combo-a" data-nextcombo=".combo-b">
                                                            <!-- parent -->
                                                ...
                                                <div class="mt-6 hidden" id="stud">
                                                    ...
                                                    <div class="w-1/2 mr-2">
                                                        <x-form.select name="academy_id2" title="Akadémia"
                                                            class=" combo-a3" data-nextcombo=".combo-b3">
                                                    ...
                                                    <div class="w-1/2 ml-2">
                                                        <x-form.select name="coursetype_id2" title="Kurz"
                                                            class="combo-b3" disabled>
                                                            <!-- child -->
                                                            {{-- <select name="coursetype_id" id="coursetype_id"
                                                                class="combo-b" data-nextcombo=".combo-c" disabled>
                                                                <option value="" disabled selected hidden>Typ kurzu
                                    ...
                                    <div id="kurzy"
                                        class="section {{ session('success_c') || session('success_d') || request()->has('pridat') ? '' : 'hidden' }}flex-auto p-6">
                                        <p class="text-sm font-semibold uppercase text-gray-700">Prihlášky tohto študenta</p>
                                        <x-single-table>
                                            <x-slot:head>
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-full md:flex-0">
                                                    <div class="mb-4">
                                                        ...
                                                        <input disabled type="text" name="username"
                                                            value="{{$student->login->nickname ?? ''}}" required
