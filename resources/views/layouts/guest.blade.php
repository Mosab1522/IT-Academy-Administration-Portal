...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen w-full flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-800">
            <div class="flex items-center justify-center lg:-mt-10  p-4 w-9/12 lg:w-1/5 ">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-100 overflow-hidden shadow-md rounded-lg">
                {{ $slot }}
            </div>
        </div>
    </body>
