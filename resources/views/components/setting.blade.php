...
<div class="flex">
    <div class="w-48 pl-6 pt-6 ">
        ...
        <h4 class="my-4 font-semibold " title="- musí to vedieť že či existuje už daný študent a keď nie tak vytvoriť nového inak priradiť.">Vytváranie prihlášky</h4>
        ...
        <h4 class="absolute bottom-6 font-semibold " title="-php basics ten 7 hodinovy na laracaste, - eloquent relations na laracaste, niečo na validáciu">Kuknúť videá</h4>
