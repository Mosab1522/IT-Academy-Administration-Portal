...
>
    <div class="flex flex-col bg-gray-800 text-white h-screen p-4">
        <div class="flex items-center justify-center -mt-3 p-4 w-full">
        ...
        <div>
            ...
            <div class="grid grid-cols-2 flex items-center justify-center -mt-3 p-4 w-full">
        ...
        <div class="mt-4">
            <div x-show="activeSection === 'management'" class="mx-8 md:mx-4 lg:mx-2 space-y-0.5 text-base lg:text-sm font-medium" x-transition>
                <a href="/admin/academies"
                class="{{ request()->is('admin/academies', 'admin/academies/*') ? 'text-indigo-300' : 'hover:text-gray-300' }} flex items-center py-2 px-3 rounded-md  hover:bg-gray-700 transition-colors duration-200 ">
                Akadémie</a>
            <a href="/admin/coursetypes"
                class="{{ request()->is('admin/coursetypes', 'admin/coursetypes/*') ? 'text-indigo-300' : 'hover:text-gray-300' }} flex items-center py-2 px-3 rounded-md  hover:bg-gray-700 transition-colors duration-200">
                Typy kurzy</a>
            <a href="/admin/classes"
                class="{{ request()->is('admin/classes', 'admin/classes/*') ? 'text-indigo-300' : 'hover:text-gray-300' }} flex items-center py-2 px-3 rounded-md  hover:bg-gray-700 transition-colors duration-200">
                Triedy</a>
            <a href="/admin/lessons"
                class="{{ request()->is('admin/lessons', 'admin/lessons/*') ? 'text-indigo-300' : 'hover:text-gray-300' }} flex items-center py-2 px-3 rounded-md  hover:bg-gray-700 transition-colors duration-200">
                Hodiny</a>
            <a href="/admin/students"
                class="{{ request()->is('admin/students', 'admin/students/*') ? 'text-indigo-300' : 'hover:text-gray-300' }} flex items-center py-2 px-3 rounded-md  hover:bg-gray-700 transition-colors duration-200">
                Študenti</a>
            <a href="/admin/applications"
                class="{{ request()->is('admin/applications', 'admin/applications/*') ? 'text-indigo-300' : 'hover:text-gray-300' }} flex items-center py-2 px-3 rounded-md  hover:bg-gray-700 transition-colors duration-200">
                Prihlášky</a>
            <a href="/admin/instructors"
                class="{{ request()->is('admin/instructors', 'admin/instructors/*') ? 'text-indigo-300' : 'hover:text-gray-300' }} flex items-center py-2 px-3 rounded-md  hover:bg-gray-700 transition-colors duration-200">
                Inštruktori</a>
            </div>
        </div>
    </div>
