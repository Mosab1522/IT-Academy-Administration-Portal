<x-email-layout>
    ...
    <p>dňa {{$data['date']}} sa uskutoční hodina vašej triedy {{ $data['classname'] }} vrámci kurzu {{$data['coursename']}}.</p>
    ...
    <ul>
        ...
        @if($data['lessonType'])
            ...
            <li>Forma hodiny: {{$data['lessonType']=='1' ? 'prezenčne' : ''}} {{$data['lessonType']=='2' ? 'online' : ''}}  </li>
        @endif
