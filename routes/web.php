...
Route::get('admin/coursetypes', [CourseTypeController::class, 'index'])->name('admin.coursetypes.index');Route::patch('admin/coursetypes/{coursetype}', [CoursetypeController::class, 'update']);
